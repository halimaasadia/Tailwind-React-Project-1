...
const Footer = () => {
          ...
          <div className="flex justify-between">
            <div className="w-2/5">
              ...
              <div className="flex gap-x-[5px]">
                ...
                <p className="font-pops text-white font-normal text-sm">
              ...
              <div className="flex gap-x-[5px]">
                ...
                <p className="font-pops text-white font-normal text-sm width-[309px]">
  ...
  <path d="M14.3553 3.741C14.3655 3.88313 14.3655 4.02528 14.3655 4.16741C14.3655 8.50241 11.066 13.4973 5.03553 13.4973C3.17766 13.4973 1.45178 12.9593 0 12.0253C0.263969 12.0557 0.51775 12.0659 0.791875 12.0659C2.32484 12.0659 3.73603 11.5481 4.86294 10.6649C3.42131 10.6344 2.21319 9.69025 1.79694 8.39075C2 8.42119 2.20303 8.4415 2.41625 8.4415C2.71066 8.4415 3.00509 8.40088 3.27919 8.32985C1.77666 8.02525 0.649719 6.70547 0.649719 5.11157V5.07097C1.08625 5.31463 1.59391 5.46691 2.13194 5.48719C1.24869 4.89835 0.670031 3.89328 0.670031 2.75622C0.670031 2.1471 0.832437 1.58872 1.11672 1.10141C2.73094 3.09125 5.15734 4.39072 7.87812 4.53288C7.82737 4.28922 7.79691 4.03544 7.79691 3.78163C7.79691 1.9745 9.25884 0.502441 11.0761 0.502441C12.0202 0.502441 12.873 0.898379 13.472 1.53797C14.2131 1.39585 14.9238 1.12172 15.5533 0.746098C15.3096 1.50753 14.7918 2.14713 14.1116 2.55319C14.7715 2.48216 15.4111 2.29938 15.9999 2.0456C15.5533 2.69532 14.9949 3.27397 14.3553 3.741Z" fill="white"/>
</svg>
{/* {/* </div>
...
// </div> */}
            ...
            <div className="w-2/5">
              <h4 className="text-white text-base font-bold font-pops mt-[176px] ml-][145px] mr-[59px] mb-[21px] ">
                Company
              </h4>
              <ul className="text-white">
                <li className="text-white">
                  <a href="font-pops text-sm font-normal text-white">Home</a>
                </li>
                <li>
                  <a href="font-pops text-sm font-normal text-white">About</a>
                </li>
                <li>
                  <a href="font-pops text-sm font-normal text-white">
                    Services
                  </a>
                </li>
                <li>
                  <a href="font-pops text-sm font-normal text-white">Gallery</a>
                </li>
              </ul>
            </div>
            <div className="w-1/5">
              <h4 className="text-white font-pops text-base font-bold mt-[180px]">
                Others
              </h4>
              <ul>
                <li>
                  <a href="" className="font-pops text-sm font-bold text-white">
                    Blog
                  </a>
                </li>
                <li>
            ...
            <div>
              <h4 className="mb-[21px] mt-[176px] text-white text-base font-bold ml-[65px]">
                Certificate
              </h4>
              <div className="flex gap-x-[5px]">
                <a
                  href=""
                  className="text-[#008AD8] font-bold text-2xl font-pops bg-white rounded w-[110px] h-[44px] mt-[21px] mb-[282px] ml-[48px] pt-[6px] pb-[5px] pr-[24px] pl-[9px]"
                >
                  ISO 88
                </a>
                <a
                  href=""
                  className="text-[#980077] font-bold text-sm rounded bg-white font-pops mt-[21px] w-[110px] h-[44px] pt-[10px] pb-[10px] pl-[11px] pr-[10px] mb-[282px] mr-[390px]"
                >
                  LiquidGreen
                </a>
              </div>
